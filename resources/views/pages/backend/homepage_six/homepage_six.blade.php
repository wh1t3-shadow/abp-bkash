    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('/six-section-submit') }} " method="post" enctype="multipart/form-data">
                    @csrf
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($data22 as $data22)
                    <tr>
                      <th>{{ $data22->id }}</th>
                      <td>{{ $data22->title }}</td>
                      <td>{{ $data22->dis }}</td>
                      <td><img src="{{ url('images/'.$data22->image) }}" alt=""> </td>
                      <td><a class="btn btn-warning" href="six-section-edit/{{ $data22->id }}">Edit</a></td>
