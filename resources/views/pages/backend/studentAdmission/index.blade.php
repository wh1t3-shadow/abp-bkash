                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST"
                                    action="{{ url('/student-admit/create') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="studentPhone" id="studentPhone" class="form-control">
                                    </div>
                                    <label for="paymentStatus">Payment Status</label>
                                    <br><br>
                                    <div class="form-group">
                                        <input type="radio" name="studentPaymentStatus" id="studentPaid" value="1"
                                            onfocusin="paidStatus()">
                                        <label for="studentPaid">Paid</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="radio" name="studentPaymentStatus" id="studentUnPaid" value="-1"
                                            onfocusin="unpaidStatus()">
                                        <label for="studentUnPaid">Unpaid</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="radio" name="studentPaymentStatus" id="studentDue" value="-2"
                                            onfocusin="dueAmount()">
                                    ...
                                    <div class="form-group" style="display: none" id="dueAmountInput">
                                        ...
                                        <input type="text" name="studentDueAmount" id="studentDueAmount"
                                            class="form-control">
                                    </div>
